...
const InitTabBar = async () => { //uses global TAB_BAR_CONFIG variable
...
const ChangeSVGFill = async (src: string, colourHex: string) => { //Takes an SVG file, changes all the visible paths to a single colour, and returns the SVG as embeddable HTML
